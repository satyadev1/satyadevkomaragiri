export const hero = {
  ...
  contact: {
    email: 'komaragirisatyadev1007@gmail.com',
    phone: '+91 9290616167',
    linkedin: 'https://www.linkedin.com/in/satyadevkomaragiri/',
    github: 'https://github.com/satyadev1',
    medium: 'https://medium.com/@satyadevk',
  },
  stack: [
    { label: 'Java', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg' },
    { label: 'Spring Boot', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg' },
    { label: 'Python', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg' },
    { label: 'React', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg' },
    { label: 'Kubernetes', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kubernetes/kubernetes-plain.svg' },
    { label: 'Google Cloud', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/googlecloud/googlecloud-original.svg' },
    { label: 'Docker', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg' },
    { label: 'Terraform', logoUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/terraform/terraform-original.svg' },
  ],
};
...
export const companies = [
  ...
  {
    name: 'Hexagon AB',
    tenure: '2017 - 2021 · 4 yrs',
    logoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Hexagon_logo.svg',
...
export const featured = [
  ...
  },
  {
    ...
    desc: 'Agentic AI, Python APIs, React UI for digital workers at OpenText (OTEX).',
    tag: 'OpenText (OTEX)',
    logoUrl: 'https://cdn.simpleicons.org/opentext',
    fallbackLogoUrl: 'https://www.google.com/s2/favicons?domain=opentext.com&sz=128',
  },
  {
    title: 'Product Scale',
    desc: 'Delivered strong product quality at Hexagon AB with zero CR/SR rejections.',
    tag: 'Hexagon AB',
    logoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Hexagon_logo.svg',
    fallbackLogoUrl: null,
  },
  {
    title: 'Vendor Delivery for IBM',
    desc: 'Delivered IBM Security Identity vendor work through Persistent Systems, including features and fixes shipped 20 days early.',
...
export const timeline = [
  ...
  },
  {
    ...
    company: 'Hexagon AB',
    location: 'Hyderabad',
    description: 'HxGN OnCall Records (WebRMS) - Records management system with real-time alerts, search, and reporting. Developed 3 entire modules (21 Point Stories), unit tests, and worked in Agile 2-week sprints. Later upgraded OnCall Records 10.0 with Spring Boot, ported 250+ action classes, handled data migration, and resolved jQuery issues.',
    tech: ['Struts', 'Spring MVC', 'Spring Boot', 'Java 8', 'Hibernate', 'Gradle', 'MS SQL', 'Oracle DB', 'jQuery'],
    logoUrl: 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Hexagon_logo.svg',
    fallbackLogoUrl: null,
  },
  {
    ...
    location: 'Hyderabad',
    description: 'Master of Business Administration. Pursued alongside hands-on software development work at Persistent Systems.',
    logoUrl: null,
  },
  {
    id: 'persistent',
